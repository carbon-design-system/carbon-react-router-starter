...
/**
 * Link 4 Sub-link 1 route (/link-4/sub-link-1)
 *
 ...
 */
export default function Link4SubLink1Route() {
  return <Placeholder />;
}

/**
 * Metadata for Link 4 Sub-link 1 route
 *
 * @see https://reactrouter.com/start/framework/route-module#meta
 */
export function meta() {
  return [
    { title: 'Sub-link 1 - Carbon React Router Starter' },
    { name: 'description', content: 'Link 4 Sub-link 1 page' },
  ];
}
